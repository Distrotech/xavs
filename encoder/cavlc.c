...
static void block_residual_write_cavlc( xavs_t *h, bs_t *s, int i_idx, int *l, int i_count )
{
    int level[16], run[16];
...
static void cavlc_qp_delta( xavs_t *h, bs_t *s )
{
...
static void cavlc_mb8x8_mvd( xavs_t *h, bs_t *s, int i_list, int i )
{
...
static inline void xavs_macroblock_luma_write_cavlc( xavs_t *h, bs_t *s, int i8start, int i8end )
{
    int i8, i4, i;
 ...
 *****************************************************************************/
int xavs_partition_size_cavlc( xavs_t *h, int i8, int i_pixel )
{
    bs_t s;
    const int i_mb_type = h->mb.i_type;
    int j;
