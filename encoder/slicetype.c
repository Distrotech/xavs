/*****************************************************************************
 * slicetype_decision.c: xavs encoder library
 *****************************************************************************
...
static void xavs_lowres_context_init( xavs_t *h, xavs_mb_analysis_t *a )
{
...
int xavs_slicetype_mb_cost( xavs_t *h, xavs_mb_analysis_t *a,
...
int xavs_slicetype_frame_cost( xavs_t *h, xavs_mb_analysis_t *a,
                               xavs_frame_t **frames, int p0, int p1, int b )
{
    int i_score = 0;
