...
static void predict_8x8c_dc_128( uint8_t *src, int i_neighbor )
{
    PREDICT_8x8_DC(0x80808080);
}

static void predict_8x8c_dc_left( uint8_t *src, int i_neighbor )
{  //int i;
...
static void predict_8x8c_dc_top( uint8_t *src, int i_neighbor )
{
	int i;
...
static void predict_8x8c_dc( uint8_t *src, int i_neighbor )
{
    PREDICT_8x8_LOAD_LEFT(0)
    PREDICT_8x8_LOAD_TOP(0)
	//for(  i = 0 ; i < 8 ; i++)
