...
#define IDCT8_Horizontal_1D {\
	 ...
	 a5 = (((b2-b6)+(1<<2)))>>3;\
	 a4 = (((b3-b7)+(1<<2)))>>3;\
     a0  = (a0 < -32768)? -32768: ((a0 > 32768)? 32768 : a0); \
	 a1  = (a1 < -32768)? -32768: ((a1 > 32768)? 32768 : a1); \
	 a2  = (a2 < -32768)? -32768: ((a2 > 32768)? 32768 : a2); \
	 a3  = (a3 < -32768)? -32768: ((a3 > 32768)? 32768 : a3); \
	 a7  = (a7 < -32768)? -32768: ((a7 > 32768)? 32768 : a7); \
	 a6  = (a6 < -32768)? -32768: ((a6 > 32768)? 32768 : a6); \
	 a5  = (a5 < -32768)? -32768: ((a5 > 32768)? 32768 : a5); \
	 a4  = (a4 < -32768)? -32768: ((a4 > 32768)? 32768 : a4); \
	 DST(0,a0);\
	 DST(1,a1);\
	 DST(2,a2);\
	 DST(3,a3);\
